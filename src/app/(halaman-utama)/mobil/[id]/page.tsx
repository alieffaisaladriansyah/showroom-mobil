...
import { CheckCircle2, Calendar, ShieldCheck, Tag } from "lucide-react";
    ...
    <main className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="grid grid-cols-4 gap-4">
                {mobil.gambar_urls
                  ...
                  .map((imgUrl: string, idx: number) => (
                    <div
                      key={idx}
                      className="aspect-[16/10] rounded-xl overflow-hidden bg-white border border-slate-200 cursor-pointer hover:border-blue-600 transition-all"
                    >
                      <img
                        src={imgUrl}
                        alt={`Koleksi ${idx}`}
          ...
          {/* SISI KANAN: Informasi Konten & Form Aksi */}
          <section
          ...
          >
            ...
            <div className="space-y-3 pt-2">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded-xl transition-colors shadow-sm text-sm"
              >
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-semibold py-3 px-4 rounded-xl transition-colors shadow-sm text-sm"
              >
